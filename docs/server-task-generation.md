...
This document describes the task types generated by the server (using AI) for the Learn Helper learning system. Each task type is generated dynamically based on the target vocabulary item.
...
**Description**: Students arrange shuffled Ukrainian words to form the correct translation of an English sentence containing the target item.
...
- **English sentence**: Mid-length, sentence case, and includes the exact target item (case-insensitive) or a minimal grammatical variant limited to inflection/conjugation of verbs or auxiliaries within the target (e.g., "be going to" -> "is going to"). Do not swap function words such as articles or prepositions.
...
**Description**: Students arrange shuffled English words to form the correct translation of a Ukrainian sentence containing the translated target item.
