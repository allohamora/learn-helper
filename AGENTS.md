...
- Before committing, show the proposed commit message and ask for confirmation once (e.g. "Ready to commit as `<message>`. Go ahead?"). On a yes, commit and push in that same step - don't ask again separately for the push.
