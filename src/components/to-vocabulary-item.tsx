...
export const ToVocabularyItem: FC<PropsWithChildren<ToVocabularyItemProps>> = ({
  title,
  subtitle,
  ...
  const handleCheck = () => {
    const correct = compare({ answer: data.vocabularyItem, input: userInput });
                ...
                {isCorrect ? (
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground">
                      ...
                      <span className="font-semibold text-foreground">{data.vocabularyItem}</span>
                    </p>
                  </div>
                )}
              </div>
