  ...
  return (
    <div className="space-y-4 md:space-y-8">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="gap-0 py-4 md:py-6">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 px-4 pb-2 md:px-6">
            <CardTitle className="text-sm font-medium">Words Updated</CardTitle>
            <Pencil className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent className="px-4 md:px-6">
            <div className="text-2xl font-bold">{general.totalWordsUpdated.toLocaleString()}</div>
            <p className="text-xs text-muted-foreground">words updated</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid gap-4 md:gap-6 lg:grid-cols-2">
        ...
        <Card className="py-4 md:py-6">
          <CardHeader className="space-y-1 px-4 md:px-6">
            ...
            <CardDescription className="text-sm">Daily words updated</CardDescription>
          </CardHeader>
          <CardContent className="mt-auto px-4 pt-2 md:px-6">
            <ChartContainer config={wordUpdatedChartConfig}>
              <AreaChart
                accessibilityLayer
                data={data.wordsUpdatedPerDay.map((item) => ({
                  ...item,
                  date: toDateWithoutYear(item.date),
                }))}
              >
